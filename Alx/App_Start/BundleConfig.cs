...
namespace Alx
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundle/plugins/morris").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/themes/base/css").Include(
                        ...
                        "~/Content/themes/base/bootstrap-rtl.css",
                        "~/Content/themes/base/sb-admin.css",
                        "~/Content/themes/base/bootstrap.min.css",
                        "~/Content/themes/base/sb-admin-rtl.css",
